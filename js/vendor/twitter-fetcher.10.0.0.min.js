/*! Twitter Post Fetcher v10.0 Coded by Jason Mayes 2013. A present to all the developers out there. | www.jasonmayes.com | Please keep this disclaimer with my code if you use it. Thanks. :-) | Got feedback or questions, ask here: http://www.jasonmayes.com/projects/twitterApi/ | Updates will be posted to this site.
*/
    ...
    return {
        ...
        callback: function (e) {
            ...
            for (a = 0; a < d;) {
                ...
                b = "";
                s ? (r && (b += '<div class="twitter__user">' + x(g[a].innerHTML) + "</div>"), b += '<p class="twitter__tweet">' + x(e[a].innerHTML) + "</p>", q && (b += '<p class="twitter__time-posted">' + f[a].getAttribute("aria-label") + "</p>")) : e[a].innerText ? (r && (b += '<p class="twitter__user">' + g[a].innerText + "</p>"), b += '<p class="twitter__tweet">' + e[a].innerText +
                    "</p>", q && (b += '<p class="twitter__time-posted">' + f[a].innerText + "</p>")) : (r && (b += '<p class="twitter__user">' + g[a].textContent + "</p>"), b += '<p class="twitter__tweet">' + e[a].textContent + "</p>", q && (b += '<p class="twitter__time-posted">' + f[a].textContent + "</p>"));
                A && (b += '<p class="twitter__interact"><a href="https://twitter.com/intent/tweet?in_reply_to=' + h[a] + '" class="twitter__reply">Reply</a><a href="https://twitter.com/intent/retweet?tweet_id=' + h[a] + '" class="twitter__retweet">Retweet</a><a href="https://twitter.com/intent/favorite?tweet_id=' +
                    h[a] + '" class="twitter__favourite">Favorite</a></p>');
                c.push({
                	markup: b,
                	id: h[a]
                });
